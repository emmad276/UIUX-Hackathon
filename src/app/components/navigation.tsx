...
const Navigation = () => {
  return (
    <div>
        {/* announcement bar */}
        <div className="text-white w-full h-auto flex flex-col sm:flex-row justify-between items-center py-2 sm:py-[14px] px-4 sm:px-[300px] bg-[#272343]">
          {/* Left Section */}
    ...
    <div className="w-full h-auto flex flex-col sm:flex-row justify-between items-center py-6 px-4 sm:px-[50px] md:px-[100px] lg:px-[150px] gap-4  ">
      ...
      <ul className="flex flex-wrap justify-center sm:justify-start gap-4 sm:gap-[32px] text-[#007580]">
        <li className={`${inter.className} font-medium text-[14px] sm:text-[15px] leading-[15.4px]`}>Home</li>
        <li className={`${inter.className} font-medium text-[14px] sm:text-[15px] leading-[15.4px]`}>Shop</li>
        <li className={`${inter.className} font-medium text-[14px] sm:text-[15px] leading-[15.4px]`}>Product</li>
        <li className={`${inter.className} font-medium text-[14px] sm:text-[15px] leading-[15.4px]`}>Pages</li>
        <li className={`${inter.className} font-medium text-[14px] sm:text-[15px] leading-[15.4px]`}>About</li>
      </ul>

      {/* Contact Section */}
      <div className="hidden md:flex flex-wrap items-center justify-center sm:justify-end gap-2 text-center sm:text-left">
        <h1 className={`${inter.className} font-normal text-[14px] leading-[15.4px] text-[#636270]`}>Contact:</h1>
        <h1 className={`${inter.className} font-medium text-[14px] leading-[15.4px] text-[#272343]`}>(808) 555-0111</h1>
      </div>
    </div>
