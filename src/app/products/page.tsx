...
const ProductPage = () => {
  return (
    ...
    <section className="bg-gray-100 w-full py-12">
      {/* Text Container */}
      <div className="w-[77.5%] mx-auto text-center space-y-8">
      ...
      <form className="flex items-center gap-4">
        {/* Email Input Field */}
        <div className="border-b border-gray-700 w-[500px] flex items-center">
          <input
            type="email"
            placeholder="Email Address..."
            className="w-full bg-transparent outline-none px-2 py-1 text-gray-700 placeholder-gray-500"
          />
        </div>
        ...
        <button
          type="submit"
          className="px-2 py-1 border border-gray-500 text-gray-700 font-semibold hover:bg-gray-100 transition"
        >
          SUBMIT
        </button>
      </form>
        ...
        <h3 className="text-3xl  text-black font-bold  leading-[58.59px]">
